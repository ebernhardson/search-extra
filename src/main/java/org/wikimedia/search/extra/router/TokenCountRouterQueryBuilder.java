...
public class TokenCountRouterQueryBuilder extends AbstractRouterQueryBuilder<Condition, TokenCountRouterQueryBuilder> {
    ...
    private final static ObjectParser<ConditionParserState<Condition>, QueryParseContext> COND_PARSER;

    static {
        COND_PARSER = new ObjectParser<>("condition", () -> new ConditionParserState<>(Condition::new));
